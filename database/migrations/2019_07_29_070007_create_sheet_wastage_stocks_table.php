...
class CreateSheetWastageStocksTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sheet_wastage_stocks', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sheet_wastage_stocks');
    }
}
