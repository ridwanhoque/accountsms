                    ...
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            ...
                            <div class="form-group row add_asterisk">
                                ...
                                <div class="col-md-8">
                                    <input name="name" value="{{ old('name') ? : $company->name }}" class="form-control" type="text" placeholder="Company Name">
                            ...
                            <div class="form-group row add_asterisk">
                                ...
                                <div class="col-md-8">
                                    <input name="phone" value="{{ old('phone') ? : $company->phone }}" class="form-control" type="text" placeholder="Company Phone Number">
                            ...
                            <div class="form-group row add_asterisk">
                                ...
                                <div class="col-md-8">
                                    <input name="email" value="{{ old('email')? : $company->email }}" class="form-control" type="email" placeholder="Company Email">
                            ...
                            <div class="form-group row add_asterisk">
                                ...
                                <div class="col-md-8">
                                    <input name="website" value="{{ old('website')? : $company->website }}" class="form-control" type="text" placeholder="Company Website">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-8">
                                    <textarea name="address" id="" cols="30" rows="6" class="form-control" placeholder="Company Address">{{ old('address')? : $company->address }}</textarea>
                                ...
                                <div class="col-md-8">
                                    <div class="img-responsive">
                                        @if ($company->company_logo == 'default.jpg')
                                            <img id="blah" src="{{ asset('uploads/default.jpg') }}" height="94px" width="190px" class="img-thumbnail" alt="">
                                            @else
                                            <img id="blah" src="{{ asset('uploads/company/'.$company->company_logo) }}" height="94px" width="190px" class="img-thumbnail" alt="">
                                        @endif
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <button class="btn btn-primary pull-right" type="submit" type="submit"><i
                                                class="fa fa-fw fa-lg fa-check-circle"></i>Update Company</button>
                                </div>
                            </div>
                        </div>
