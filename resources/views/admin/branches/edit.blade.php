...
<main class="app-content">
  ...
  <div class="app-title">
    <div>
      ...
      <p>Update Branch Form</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Branchs</li>
      <li class="breadcrumb-item"><a href="#">Edit Branch</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <h3 class="tile-title">Edit New Branch</h3>
        ...
        <div class="tile-body">
          ...
          <div class="form-group row add_asterisk">
            ...
            <div class="col-md-8">
              <input name="name" value="{{ old('name') ?: $branch->name }}" class="form-control" type="text" placeholder="Branch Name">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Branch Description">{{ old('description') ?: $branch->description }}</textarea>
          ...
          <div class="row">
            <div class="col-md-12">
              <button class="btn btn-primary pull-right" type="submit" type="submit"><i
                  class="fa fa-fw fa-lg fa-check-circle"></i>Edit Branch</button>
            </div>
          </div>
        </div>
