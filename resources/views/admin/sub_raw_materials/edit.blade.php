...
<main class="app-content">
  <form class="form-horizontal" method="POST" action="{{ route('sub_raw_materials.update', $subRawMaterial->id) }}">
    @csrf
    @method('PUT')
    <div class="app-title">
      <div>
        <h1><i class="fa fa-edit"></i> Sub Raw Material Information</h1>
        <p>Update Sub Raw Material Form</p>
      </div>
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item">Sub Raw Materials</li>
        <li class="breadcrumb-item"><a href="#">Edit Sub Raw Material</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <h3 class="tile-title">Edit New Sub Raw Material</h3>
          ...
          <div class="tile-body">
            ...
            <div class="form-group row add_asterisk">
              ...
              <div class="col-md-8">
                <select name="raw_material_id" class="form-control">
                  ...
                  <option value="{{ $raw_material->id }}" {{ $subRawMaterial->raw_material_id == $raw_material->id ? 'selected':'' }}>{{ $raw_material->name }}</option>
                  @endforeach
                </select>
            ...
            <div class="form-group row add_asterisk">
              ...
              <div class="col-md-8">
                <input name="name" value="{{ $subRawMaterial->name }}" class="form-control" type="text"
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <textarea name="description" id="" cols="30" rows="10" class="form-control"
                  placeholder="Sub Raw Material Description">{{ $subRawMaterial->description }}</textarea>
            ...
            <div class="row">
              <div class="col-md-12">
                <button class="btn btn-primary pull-right" type="submit" type="submit"><i
                    class="fa fa-fw fa-lg fa-check-circle"></i>Edit Sub Raw Material</button>
              </div>
            </div>
          </div>
