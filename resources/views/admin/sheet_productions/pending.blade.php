      ...
      <div class="row">
        <div class="col-md-12">
          ...
          @if(Session::get('error_message'))
            ...
            @endif
          <div class="tile">
            <a href="{{route('sheet_productions.create')}}" class="btn btn-primary" style="float: right;"><i class="fa fa-plus"></i>Add Sheet Productions</a>
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        ...
                        <a class="btn btn-danger btn-sm" title="Delete" onclick="" href="{{ url('sheet_productions/delete_pending', $sheet_production->id) }}"> <i class="fa fa-trash"></i> </a>
                        
                            <form action="{{ url('sheet_productions/delete_pending', $sheet_production->id)}}" id="deleteForm_{{$sheet_production->id}}" method="POST">
                                @csrf
                                @method("DELETE")
                            </form>  
                      </td>
