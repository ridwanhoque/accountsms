          ...
          <div class="tile">
            ...
            <div class="tile-body">
              ...
              <table class="table table-bordered" id="stock_table">
                ...
                <tbody>
                  {{-- @dd($sheet_wastage_stocks->first()) --}}
                    @isset($sheet_wastage_stocks)
                        @foreach ($sheet_wastage_stocks as $wastage_stock)
                        <tr>
                          <td>{{ $wastage_stock->sub_raw_material->raw_material->name.' - '.$wastage_stock->sub_raw_material->name }}</td>
...
$("#submitBtn").on('click', function(){
  ...
  var url_data = 'sheet_wastage_id='+sheet_wastage_id+'&purchase_date_from='+purchase_date_from+'&purchase_date_to='+purchase_date_to;
      $.ajax({
      url: "{{ url('reports/sheet_wastage_stocks/filter') }}",
      type: "GET",
      ...
      success:function(res){
        $.each(res, function(key, value){
          ...
          '<td>'+total_sold+'</td>'+
          '<td>'+value['sheet_wastage_stock']['available_quantity']+'</td>'+
          '</tr>';
