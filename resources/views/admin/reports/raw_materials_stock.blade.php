    ...
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <div class="tile-body">
          ...
          <table class="table table-bordered text-center print-area" id="raw_material_stock_table">
            <thead class="print-area">
              <tr class="display_when_print">
                <th colspan="11" class="">Raw Material Stock Report</th>
              </tr>
              <tr>
...
<script src="{{ asset('assets/admin/js/jquery-3.2.1.min.js') }}"></script>
 ...
 <script type="text/javascript">
   ...
   $('#raw_material_stock_table').dataTable({
       dom: 'Bfrtip',
       buttons: [
           'print'
       ]
