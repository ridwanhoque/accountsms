...
<main class="app-content">
  ...
  <div class="app-title">
    <div>
      ...
      <p>Create Machine Form</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Machines</li>
      <li class="breadcrumb-item"><a href="#">Add Machine</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <h3 class="tile-title">Add New Machine</h3>
        ...
        <div class="tile-body">
          ...
          <div class="form-group row add_asterisk">
            ...
            <div class="col-md-8">
              <input name="name" value="{{ old('name') }}" class="form-control" type="text" placeholder="Machine Name">
          ...
          <div class="form-group row add_asterisk">
            ...
            <div class="col-md-8">
              <input name="model" value="{{ old('model') }}" class="form-control" type="text" placeholder="Machine Model">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input name="push_per_minute" value="{{ old('push_per_minute') }}" class="form-control" type="text" placeholder="Push Per Minute">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <input name="purchase_date" value="{{ old('purchase_date') }}" class="form-control dateField" type="text" placeholder="Purchase Date" value="{{ old('purchase_date') ?: date("Y-m-d") }}">
          ...
          <div class="row">
            <div class="col-md-12">
              <button class="btn btn-primary pull-right" type="submit" type="submit"><i
                  class="fa fa-fw fa-lg fa-check-circle"></i>Add Machine</button>
            </div>
          </div>
        </div>
