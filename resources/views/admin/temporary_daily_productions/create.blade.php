...
<main class="app-content" style="background-color:white">
  <form class="form-horizontal" method="POST" action="{{ route('temporary_daily_productions.store') }}">
    @csrf
    <input type="hidden" name="is_approved" value="0">
    <input type="hidden" name="status_id" value="1">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-edit"></i> Finish Production</h1>
        <p>Create Finish Production Form</p>
      </div>
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item">Finish Productions</li>
        <li class="breadcrumb-item"><a href="#">Add Finish Production</a></li>
      </ul>
    </div>
    <div class="row" style="">
      <div class="col-md-12" style="padding:0px" >
        ...
        <!-- <div class="tile"> -->
          ...
          <a href="{{ route('temporary_daily_productions.index') }}" class="btn btn-primary pull-right" style="float: right;"><i
              class="fa fa-eye"></i>View Finish Production</a>
          <h3 class="tile-title">Add New Finish Production</h3>
          ...
          <!-- <div class="tile-body"> -->
            ...
            <input type="hidden" name="status_id" value="1">
            <!-- {{-- <div class="form-group row add_asterisk">
              <label for="" class="control-label col-md-3">Finish Production Status</label>
              <div class="col-md-8">
        ...
        <table class="table r-container no-spacing" id="daily_production_table">
          <thead>
            ...
            <th width="15%">Sheet N -Color</th>
              <th width="13.5%">Stock (kg/roll) </th>
              <th width="8%">Used (kg)</th>
              <th width="5%">Used (roll)</th>
              <th width="16%">Product N</th>
              <th width="10%">Machine</th>
              <th width="8%">Finish Qty</th>
              <th width="5%">Pack</th>
          ...
          @if(old() == true)
            ...
            <tr class=" r-group" style="text-align:center">
                ...
                <td>
                  ...
                  <option value="0">select</option>
                    ...
                    <option value="{{ $sheet_size_color_material->id }}" {{ old('sheet_size_color_ids')[$key] == $sheet_size_color_material->id ? 'selected':'' }}>
                      {{ $sheet_size_color_material->raw_material->name ?? '-' }} {{ ' - ' }}
                      {{ $sheet_size_color_material->sheet_size->name ?? '-'}} {{ ' - '}} {{ $sheet_size_color_material->color->name ?? '-' }}
                    </option>
                    @endforeach
                  </select>
                </td>
                ...
                <td>
                <input type="text" class="form-control small_input_box sheet_current_stock" readonly="readonly" value="{{ old('sheet_stock_kg')[$key] }} / {{ old('sheet_stock_roll')[$key] }}">
          ...
          @else
            <tr class=" r-group" style="text-align:center">
              ...
              <td>
                ...
                <input type="hidden" name="sheet_stock_roll[]" class="sheet_stock_roll">
                <input type="hidden" name="sheet_stock_kg[]" class="sheet_stock_kg">
              </td>
          ...
          <div class="row">
            <div class="col-md-12">
              <button class="btn btn-primary pull-right" id="submitBtn" type="submit" type="submit"><i
                  class="fa fa-fw fa-lg fa-check-circle"></i>Add Finish Production</button>
            </div>
          </div>
        </div>
