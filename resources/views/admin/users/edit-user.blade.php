...
@section('content')
    ...
    <main class="app-content">
        <form class="form-horizontal" method="POST" action="{{ url('users/update-user') }}">
            @csrf
                        ...
                        <div class="tile-body">
                            ...
                            <div class="form-group row add_asterisk">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <input name="name" value="{{ old('name')?: $user->name }}" class="form-control" type="text" placeholder="User Name">
                            ...
                            <div class="form-group row add_asterisk">
                                ...
                                <div class="col-md-8">
                                    <input name="email" value="{{ old('email')?: $user->email }}" class="form-control" type="text" placeholder="User Email">
