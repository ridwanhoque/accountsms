...
<main class="app-content">
  <form class="form-horizontal" method="POST" action="{{ route('raw_materials.update', $rawMaterial->id) }}"> 
  @csrf
  @method('PUT')
  ...
  <div class="app-title">
    <div>
      ...
      <p>Update Raw Material Form</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Raw Materials</li>
      <li class="breadcrumb-item"><a href="#">Edit Raw Material</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <h3 class="tile-title">Edit New Raw Material</h3>
        ...
        <div class="tile-body">
          ...
          <div class="form-group row add_asterisk">
            ...
            <div class="col-md-8">
              <input name="name" value="{{ old('name') ?: $rawMaterial->name }}" class="form-control" type="text" placeholder="Raw Material Name">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Raw Material Description">{{ old('description') ?: $rawMaterial->description }}</textarea>
          ...
          <div class="row">
            <div class="col-md-12">
              <button class="btn btn-primary pull-right" type="submit" type="submit"><i
                  class="fa fa-fw fa-lg fa-check-circle"></i>Edit Raw Material</button>
            </div>
          </div>
        </div>
