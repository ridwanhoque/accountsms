...
<main class="app-content">
  <form class="form-horizontal" method="POST" action="{{ route('fm_kutchas.store') }}"> 
  @csrf

  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i> Fm Kutcha Information</h1>
      <p>Create Fm Kutcha Form</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Fm Kutchas</li>
      <li class="breadcrumb-item"><a href="#">Add Fm Kutcha</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <h3 class="tile-title">Add New Fm Kutcha</h3>
        ...
        <div class="tile-body">
          ...
          <div class="form-group row add_asterisk">
            ...
            <div class="col-md-8">
              <input name="name" value="{{ old('name') }}" class="form-control" type="text" placeholder="Fm Kutcha Name">
          ...
          <div class="form-group row">
            ...
            <div class="col-md-8">
              <textarea name="description" id="" cols="30" rows="10" class="form-control" placeholder="Fm Kutcha Description">{{ old('description') }}</textarea>
          ...
          <div class="row">
            <div class="col-md-12">
              <button class="btn btn-primary pull-right" type="submit" type="submit"><i
                  class="fa fa-fw fa-lg fa-check-circle"></i>Add Fm Kutcha</button>
            </div>
          </div>
        </div>
