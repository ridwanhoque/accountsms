...
<main class="app-content">
  <form class="form-horizontal" method="POST" action="{{ route('temporary_sheet_productions.store') }}" id="sheet_production_form">
    @csrf
    <div class="app-title">
      <div>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <a href="{{route('temporary_sheet_productions.index')}}" class="btn btn-primary pull-right" style="float: right;"><i class="fa fa-eye"></i>View Sheet Production</a>
          ...
          <div class="tile-body">
            ...
            <div class="container">
              ...
              <tr data-repeater-item class="outer" valign="top" id="addr_raw_material_table0">
                  <td>{{ $key+1 }}</td>
                      ...
                      <td width="25%">
                        ...
                        <select name="sub_raw_material_ids[]" class="form-control col-xs outer materials small_input_box" onchange="material_current_stock(this)" onchange="material_current_stock(this)">
              ...
              <input type="hidden" name="sheet_with_wastage" id="sheet_with_wastage" value="" step="0.01">
...
<script>
  ...
  function show_total_output() {
    ...
    $('#sheet_with_wastage').val((parseFloat(total_kg_details) + total_output).toFixed(2));
  }
