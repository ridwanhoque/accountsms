...
<head>
    ...
    <title>Login - Accounting System Software</title>
</head>
<body>
...
<section class="login-content">
    ...
    <div class="login-box">
        ...
        <form class="forget-form" method="POST" action="{{ route('password.email') }}">
            ...
            <div class="form-group">
                <label for="email" class="control-label">EMAIL</label>
                <input id="email" name="email" class="form-control @error('email') is-invalid @enderror" type="text" placeholder="Email">
            ...
            <div class="form-group btn-container">
                <button class="btn btn-primary btn-block"><i class="fa fa-unlock fa-lg fa-fw"></i>
