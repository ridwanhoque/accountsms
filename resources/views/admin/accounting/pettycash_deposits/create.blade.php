...
<main class="app-content">
  <form class="form-horizontal" method="POST" action="{{ route('pettycash_deposits.store') }}"> 
  @csrf
  ...
  <div class="app-title">
    <div>
      ...
      <p>Create Pettycash Deposit Form</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Pettycash Deposits</li>
      <li class="breadcrumb-item"><a href="#">Add Pettycash Deposit</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <h3 class="tile-title">Add New Pettycash Deposit</h3>
        ...
        <div class="tile-body">
          ...
          <div class="form-group row add_asterisk">
            ...
            <div class="col-md-8">
                <input type="text" class="form-control" name="pettycash_deposit_date" value="{{ date('Y-m-d') }}" readonly="readonly">
            </div>
          </div>
          ...
          <div class="form-group row add_asterisk">
            ...
            <div class="col-md-8">
              <select name="account_information_id" id="account_information_id" class="form-control select2">
                <option value="0">select</option>
                @foreach ($accounts as $account)
                    <option value="{{ $account->id }}" {{ $account->id == old('account_information_id') ? 'selected':'' }}>{{ $account->account_name }}</option>
                @endforeach
              </select>
          ...
          <div class="row">
            <div class="col-md-12">
              <button class="btn btn-primary pull-right" type="submit"><i
                  class="fa fa-fw fa-lg fa-check-circle"></i>Add Pettycash Deposit</button>
            </div>
          </div>
        </div>
...
$('#account_information_id').change(function(){
