...
<main class="app-content">
  <form class="form-horizontal" method="POST" action="{{ route('chart_of_accounts.update', $chart_of_account->id) }}">
    @csrf
    @method('PUT')
    <div class="app-title">
      <div>
      ...
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">Edit @yield('page_title')</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <h3 class="tile-title">Edit New @yield('page_title')</h3>
          ...
          <div class="tile-body">
            ...
            <div class="form-group row add_asterisk">
                ...
                <div class="col-md-9">
                  <select name="parent_id" id="parent_id" class="form-control select2 @error('parent_id') is-invalid @enderror" onchange="load_charts(this.value)">
                    ...
                    <option value="{{ $id }}" {{ $chart_of_account->parent_id == $id ? 'selected':'' }}>{{ $name }}</option>
                    @endforeach
                  </select>
            ...
            <div class="form-group row add_asterisk">
              ...
              <div class="col-md-9">
                <select name="chart_type_id" id="chart_type_id" class="form-control @error('type') is-invalid @enderror">
                  ...
                  <option value="{{ $id }}" {{ $chart_of_account->chart_type_id == $id ? 'selected':'' }}>{{ $name }}</option>
                  @endforeach
                </select>
            ...
            <div class="form-group row add_asterisk">
              ...
              <div class="col-md-9">
                <select name="owner_type_id" id="owner_type_id" class="select2 form-control @error('type') is-invalid @enderror">
                  ...
                  <option value="{{ $id }}" {{ $chart_of_account->owner_type_id == $id ? 'selected':'' }}>{{ $name }}</option>
                  @endforeach
                </select>
            ...
            <div class="form-group row add_asterisk">
              ...
              <div class="col-md-9">
                <input id="head_name" name="head_name" value="{{ old('head_name') ?: $chart_of_account->head_name }}" type="text" class="form-control @error('head_name') is-invalid @enderror" placeholder="Head Name">
            ...
            <div class="form-group row add_asterisk">
              ...
              <div class="col-md-9">
                <input id="opening_balance" name="opening_balance" value="{{ old('opening_balance') ?: $chart_of_account->opening_balance }}" type="text" class="form-control @error('opening_balance') is-invalid @enderror" placeholder="Opening Balance">
            ...
            <input type="hidden" name="account_code" id="account_code" value="{{ $chart_of_account->account_code }}">
            <input type="hidden" name="tire" id="tire" value="{{ $chart_of_account->tire }}">
            ...
            <div class="tile-footer">
              <div class="row">
                <div class="col-md-12">
                  <button class="btn btn-primary pull-right" type="submit" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Update @yield('page_title')</button>
                </div>
              </div>
            </div>
