...
<main class="app-content">
  <form class="form-horizontal" method="POST" action="{{ route('asset_charts.store') }}"> 
  @csrf

  <div class="app-title">
    <div>
      <h1><i class="fa fa-edit"></i> Asset Head Information</h1>
      <p>Create Asset Head Form</p>
    </div>
    <ul class="app-breadcrumb breadcrumb">
      <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
      <li class="breadcrumb-item">Asset Heads</li>
      <li class="breadcrumb-item"><a href="#">Add Asset Head</a></li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="tile">
        ...
        <div class="form-group row add_asterisk">
            ...
            <div class="col-md-8">
              <input name="name" value="{{ old('name') }}" class="form-control" type="text" placeholder="Asset Head Name">
          ...
          <div class="row">
            <div class="col-md-12">
              <button class="btn btn-primary pull-right" type="submit" type="submit"><i
                  class="fa fa-fw fa-lg fa-check-circle"></i>Add Asset Head</button>
            </div>
          </div>
        </div>
