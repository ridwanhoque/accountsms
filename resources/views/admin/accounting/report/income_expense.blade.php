...
@section('content')
    ...
    <main class="app-content">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="tile">
                    <h3 class="tile-title"><i class="fa fa-list"></i> &nbsp; Income List</h3>
                    ...
                    <div class="tile-body">
                        <table class="table table-hover table-bordered">
                            ...
                            @foreach($reports as $income_report)
                                @if ($income_report->voucher_type == 'credit')
                                @foreach($income_report->voucher_account_charts as $chartOfAccount)
                                <tr>
                                    <td>{{ $chartOfAccount->chart_of_account->head_name }}</td>
                                    <td>{{ $chartOfAccount->payable_amount }}</td>
                                    <td>{{ $chartOfAccount->paid_amount }}</td>
                                </tr>
                                @endforeach
                                @endif
                            @endforeach
            ...
            <div class="col-md-6">
                <div class="tile">
                    <h3 class="tile-title"><i class="fa fa-list"></i> &nbsp; Expense List</h3>
                    ...
                    <div class="tile-body">
                        <table class="table table-hover table-bordered">
                            ...
                            @foreach($reports as $expense_report)
                                @if ($expense_report->voucher_type == 'debit')

                                @foreach($expense_report->voucher_account_charts as $chartOfAccount)
                                    <tr>
                                        <td>{{ $chartOfAccount->chart_of_account->head_name }}</td>
                                        <td>{{ $chartOfAccount->payable_amount }}</td>
                                        <td>{{ $chartOfAccount->paid_amount }}</td>
