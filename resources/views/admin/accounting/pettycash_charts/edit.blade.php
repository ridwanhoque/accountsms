...
<main class="app-content">
  <form class="form-horizontal" method="POST" action="{{ route('pettycash_charts.update', $pettycashChart->id) }}">
    @csrf
    @method('PUT')
    <input type="hidden" name="id" value="{{ $pettycashChart->id }}">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-edit"></i> Pettycash Head Information</h1>
        <p>Update Pettycash Head Form</p>
      </div>
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item">Pettycash Heads</li>
        <li class="breadcrumb-item"><a href="#">Edit Pettycash Head</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
          ...
          <div class="tile-body">
            ...
            <div class="form-group row add_asterisk">
              ...
              <div class="col-md-8">
                <input name="name" value="{{ $pettycashChart->name }}" class="form-control" type="text"
                  placeholder="Pettycash Head Name">
            ...
            <div class="form-group row">
              ...
              <div class="col-md-8">
                <select name="status" class="form-control">
                  ...
                  <option value="{{ $key }}" {{ $key == $pettycashChart->status ? 'selected':'' }}>{{ $status }}</option>
                  @endforeach
                </select>
            ...
            <div class="row">
              <div class="col-md-12">
                <button class="btn btn-primary pull-right" type="submit" type="submit"><i
                    class="fa fa-fw fa-lg fa-check-circle"></i>Edit Pettycash Head</button>
              </div>
            </div>
          </div>
