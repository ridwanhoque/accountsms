              ...
              <table class="table table-hover table-bordered" id="">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        <a class="btn btn-info btn-sm" title="Edit" href="{{ route('suppliers.edit',$supplier->id) }}"> <i class="fa fa-edit"></i> </a> |
                      <a class="btn btn-primary btn-sm" title="View" href="{{ route('suppliers.show',$supplier->id) }}"> <i class="fa fa-eye"></i> </a> |
                        <a class="btn btn-danger btn-sm" title="Delete" onclick="formSubmit('{{$supplier->id}}')" href="#"> <i class="fa fa-trash"></i> </a>
                      
                      
                      <form action="{{route('suppliers.destroy', $supplier->id)}}" id="deleteForm_{{$supplier->id}}" method="POST">
                          @csrf
                          @method("DELETE")
                      </form>
