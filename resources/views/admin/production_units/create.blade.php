...
<main class="app-content">
    {{-- <form class="form-horizontal" method="POST" action="{{ route('production_units.store') }}"> --}}
        @csrf
     
        <div class="app-title">
          <div>
            <h1><i class="fa fa-edit"></i> Store</h1>
            <p>Create Production Unit Form</p>
          </div>
          <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item">Production Units</li>
            <li class="breadcrumb-item"><a href="#">Add Production Unit</a></li>
          </ul>
        </div>
        <div class="row">
                <div class="col-md-12">
                      ...
                      @endif
                        ...
                        <div class="tile">
                          ...
                          <a href="{{route('production_units.index')}}" class="btn btn-primary pull-right" style="float: right;"><i class="fa fa-eye"></i>View Production Unit</a>
                          <h3 class="tile-title">Add New Production Unit</h3>
                    ...
                    <div class="mt-4"></div>
                            ...
                            <div class="tile-footer">
                              <div class="row">
                                <div class="col-md-12">
                                  <button class="btn btn-primary pull-right" type="submit" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Add Production Unit</button>
                                </div>
                              </div>
                            </div>
