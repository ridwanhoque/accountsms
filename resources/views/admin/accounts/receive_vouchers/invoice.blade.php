        ...
        <table class="table no-spacing">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-right">
                {{ $details->chart_of_account->owner_type_id == config('app.owner_party') ? $details->amount:0 }}</td>
            </tr>
            @endforeach
            <tr>
              <td colspan="4"></td>
            ...
            <tr>
              <td colspan="4">Total : <strong>{{ Formatter::toWords($receive_voucher->amount) }} {{ config('app.tk') }}</strong></td>
            </tr>
            <tr>
              <td> <b> {{ $receive_voucher->chart_of_account->head_name ?? '' }} </b><br> <br><br>
                <hr>Signature and Date</td>
              <td>&nbsp;</td>
              <td style="text-align:right"> <b>Issued By : {{ $receive_voucher->company->name }} </b> <br> <br> <br>
                <hr> Signature and Date</td>
            </tr>
            <tr></tr>
          </tbody>
