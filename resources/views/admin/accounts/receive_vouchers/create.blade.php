...
<main class="app-content">
    ...
    <form class="form-horizontal" method="POST" action="{{ route('receive_vouchers.store') }}">
        @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tile">
                    <a href="{{ route('receive_vouchers.index') }}" class="btn btn-primary" style="float: right;"><i class="fa fa-list"></i> Voucher List</a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group form-inline">
                                                    ...
                                                    <input id="receive_date" name="receive_date" readonly value="{{ date('Y-m-d') }}" type="text" class="form-control small_input_box @error('receive_date') is-invalid @enderror" placeholder="Receive Date">
    ...
    function show_credit_balance(element){
        ...
        $.ajax({
            ...
            success:function(res){
                row.find('.credit_balance').val(Math.abs(res['balance']));
            }
        });
    }
