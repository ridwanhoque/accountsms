...
<main class="app-content">
    ...
    <form class="form-horizontal" method="POST" action="{{ route('contra_vouchers.store') }}">
        @csrf
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="tile">
                    <a href="{{ route('contra_vouchers.index') }}" class="btn btn-primary" style="float: right;"><i class="fa fa-list"></i> Voucher List</a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group form-inline">
                                                    ...
                                                    <input id="contra_date" name="contra_date" readonly value="{{ date('Y-m-d') }}" type="text" class="form-control small_input_box @error('contra_date') is-invalid @enderror" placeholder="Contra Date">
